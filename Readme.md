# Editor for DataTables with styling for [Bulma](https://bulma.io/)

This is the distribution package for the [Editor extension](https://datatables.net/extensions/editor) for [DataTables](https://datatables.net/) with styling for [Bulma](https://bulma.io/).
...
npm install datatables.net-editor-bm
```
...
import 'datatables.net-editor-bm'
